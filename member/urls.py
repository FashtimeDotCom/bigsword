...
urlpatterns=[
    ...
    url(r'^change/(?P<user>\w+)/(?P<confirm>[a-zA-Z0-9]{16})', views.ChangePassView.as_view(), name='member_non_user_change_confirm'),
    url(r'^change/', views.ChangePassView.as_view(), name='member_non_user_change_done'),
]